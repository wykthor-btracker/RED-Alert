...
export const referenceCyberware: ReferenceCyberware[] = [
  ...
  { id: "link-neural", name: "Link Neural", category: "Neuralware", price: 500, humanityCost: 7, humanityCostDice: "2d6", description: "Sistema nervoso artificial com fio. Necessário para Neuralware e Cabo Subcutâneo. Possui 5 opções de slots.", installation: "clinica", slotOptions: 5 },
  { id: "gravador-neurodanca", name: "Gravador de Neurodança", category: "Neuralware", price: 500, humanityCost: 7, humanityCostDice: "2d6", description: "Registra as experiências do usuário para chip de memória ou dispositivo externo.", installation: "clinica", requires: ["link-neural"] },
  { id: "soquete-chipware", name: "Soquete para Chipware", category: "Neuralware", price: 500, humanityCost: 7, humanityCostDice: "2d6", description: "Um soquete instalado na parte de trás do pescoço. Necessário para Chipware.", installation: "clinica", requires: ["link-neural"] },
  { id: "plugs-interface", name: "Plugs de Interface", category: "Neuralware", price: 500, humanityCost: 7, humanityCostDice: "2d6", description: "Plugues no pulso ou na cabeça que permitem conexão com máquinas.", installation: "clinica", requires: ["link-neural"] },
  { id: "kerenzikov", name: "Kerenzikov", category: "Neuralware", price: 500, humanityCost: 14, humanityCostDice: "2d6", description: "Speedware. O usuário adiciona +2 à Iniciativa. Apenas uma peça de Speedware por vez.", installation: "clinica", requires: ["link-neural"] },
  { id: "sandevistan", name: "Sandevistan", category: "Neuralware", price: 500, humanityCost: 7, humanityCostDice: "2d6", description: "Speedware. Quando ativado como Ação adiciona +3 à Iniciativa durante um minuto. 1h cooldown.", installation: "clinica", requires: ["link-neural"] },
  ...
  { id: "cyberolho", name: "Cyberolho", category: "Cyberópticos", price: 100, humanityCost: 7, humanityCostDice: "2d6", description: "Olho artificial. Cada Cyberolho tem 3 opções de slots. Algumas opções devem ser emparelhadas.", installation: "clinica", slotOptions: 3 },
  ...
  { id: "conjunto-cyberaudio", name: "Conjunto de Cyberáudio", category: "Cyberaudio", price: 500, humanityCost: 7, humanityCostDice: "2d6", description: "Tem 3 opções de slots. Não é possível instalar mais de 1.", installation: "clinica", slotOptions: 3 },
